...
func tmplCssStyleCss() (*asset, error) {
	...
	info := bindataFileInfo{name: "tmpl/css/style.css", size: 688, mode: os.FileMode(0644), modTime: time.Unix(1709231770, 0)}
...
func tmplIndexHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "tmpl/index.html", size: 11336, mode: os.FileMode(0644), modTime: time.Unix(1709231770, 0)}
...
func tmplJsMappingJs() (*asset, error) {
	...
	info := bindataFileInfo{name: "tmpl/js/mapping.js", size: 4047, mode: os.FileMode(0644), modTime: time.Unix(1709231770, 0)}
...
func tmplJsRequest_loggerJs() (*asset, error) {
	...
	info := bindataFileInfo{name: "tmpl/js/request_logger.js", size: 2077, mode: os.FileMode(0644), modTime: time.Unix(1709231770, 0)}
...
func tmplJsSortingJs() (*asset, error) {
	...
	info := bindataFileInfo{name: "tmpl/js/sorting.js", size: 1759, mode: os.FileMode(0644), modTime: time.Unix(1709231770, 0)}
...
func tmplJsUtilJs() (*asset, error) {
	...
	info := bindataFileInfo{name: "tmpl/js/util.js", size: 1395, mode: os.FileMode(0644), modTime: time.Unix(1709231770, 0)}
...
func tmplSwaggerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "tmpl/swagger.json", size: 12074, mode: os.FileMode(0644), modTime: time.Unix(1709231770, 0)}
